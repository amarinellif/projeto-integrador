...
/**
 * Class used to create a Data Transfer Object for Warehouseservice.getWarningDueDateBatchesByWarehouse method
 * @author Amanda Marinelli
 * @version 0.0.1
 * @see java.lang.Object
 */
public class WarningDueDateDto {
    private long idWarehouse;
    private String nameWarehouse;
    private List<BatchWarningDueDateDto> batchWarningDueDateDto = new ArrayList<>();

    public WarningDueDateDto(Warehouse warehouse,List<Batch> batchList) {
        this.nameWarehouse = warehouse.getName();
        this.idWarehouse = warehouse.getId();
        for (Batch b : batchList) {
            this.batchWarningDueDateDto.add(new BatchWarningDueDateDto(b));
        }
    }
